export const IPC = {
  ...
  sessionsCloseToProject: 'sessions:close-to-project',
  generationsRecent: 'generations:recent',
  systemStatus: 'system:status',
  comfyStatus: 'comfyui:status',
  comfyStream: 'comfyui:stream',
  projectsList: 'projects:list',
  projectOpen: 'project:open',
  stagesCount: 'stages:count',
  stagesCommitAll: 'stages:commit-all',
  stagesCommitted: 'stages:committed',
  ...
  mediaEnsureThumb: 'media:ensure-thumb',
