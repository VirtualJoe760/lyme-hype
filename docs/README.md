...
**Next: Phase 4** (real video/image/audio generation connections) — and the one remaining Phase 3 tail, the generic "add any connector" form (ChatRealty is a built-in template today).
